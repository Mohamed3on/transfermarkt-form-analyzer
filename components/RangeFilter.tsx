...
const inputClass =
  "h-7 text-xs tabular-nums [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none";
    ...
    <Popover>
      <PopoverTrigger
        ...
        className={cn(
          ...
          "gap-1.5 rounded-lg tabular-nums",
        )}
      >
